...
# Package meta-data.
NAME = "cotect-endpoints"
MAIN_PACKAGE = "cotect_endpoints"  # Change if main package != NAME
DESCRIPTION = "Cotect REST API user endpoints."
URL = "https://github.com/cotect/cotect/tree/master/endpoints"
